Shader "Noisemaker/filter/hs"
{
    // filter/hs — Hue and Saturation adjustment.
    // Single render pass (program "hs"). Uniforms: rotation, hueRange, saturation.
    ...
    SubShader
    {
        ...
        // progName "hs" (definition.js passes[0].program)
        Pass
        {
            Name "hs"
            HLSLPROGRAM
