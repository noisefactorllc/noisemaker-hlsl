Shader "Noisemaker/filter/sobel"
{
    // filter/sobel — classic Sobel edge detection. Single render pass.
    // Properties are for the inspector only; the runtime binds these via
    // MaterialPropertyBlock by their reference uniform names (amount/alpha) and
    // binds the input surface to inputTex.
    ...
    SubShader
    {
        ...
        // progName "sobel" (definition.js passes[0].program)
        Pass
        {
            Name "sobel"
            HLSLPROGRAM
